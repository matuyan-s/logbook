...
public class AppConstants {
    ...
    /** バージョン */
    public static final String VERSION = "2.5.7.81.Java25.3";
    ...
    /** 証明書エイリアス */
    public static final String CN_ALIAS = "LogbookCA";
    ...
    /** /icon/add.png */
    public static final String R_ICON_ADD = "/icon/add.png";

    /** /icon/delete.png */
    public static final String R_ICON_DELETE = "/icon/delete.png";

    /** /icon/error.png */
    public static final String R_ICON_ERROR = "/icon/error.png";

    /** /icon/error_mono.png */
    public static final String R_ICON_ERROR_MONO = "/icon/error_mono.png";

    /** /icon/exclamation.png */
    public static final String R_ICON_EXCLAMATION = "/icon/exclamation.png";

    /** /icon/exclamation_mono.png */
    public static final String R_ICON_EXCLAMATION_MONO = "/icon/exclamation_mono.png";

    /** /icon/folder.png */
    public static final String R_ICON_FOLDER = "/icon/folder.png";

    /** /icon/star.png */
    public static final String R_ICON_STAR = "/icon/star.png";

    /** /icon/heart.png */
    public static final String R_ICON_LOCKED = "/icon/heart.png";

    /** /icon/arrow-left.png */
    public static final String R_ICON_LEFT = "/icon/arrow-left.png";

    /** /icon/arrow-right.png */
    public static final String R_ICON_RIGHT = "/icon/arrow-right.png";
